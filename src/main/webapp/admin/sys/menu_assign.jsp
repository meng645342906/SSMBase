...
<head>
    ...
    <style>
        ...
        [class^="icon-"], [class*=" icon-"] {
            ...
            background-image: url("${basePath}/assets/img/glyphicons-halflings.png");
...
<div class="actions" style="margin-left: 300px; margin-top: 30px;">
    <my:button className="btn btn-big btn-primary" id="btn_saveOrder" textName="保存"/>
</div>
<!-- basic scripts -->
...
<script type="text/javascript" src="${basePath}/js/ztree/js/jquery.ztree.exedit.min.js"></script>
<script type="text/javascript">
...
<script>
    $(function () {
        ...
        $("#btn_saveOrder").click(function () {
            ...
            $.post("${basePath}/sys/role/saveMenuAssign", submitData, function (data) {
        ...
        function resize() {
            h = $(window).height(), th = $("#top").outerHeight(true), mh = $(".main-title h3").outerHeight(true);
