	...
	<script type="text/javascript">
		$(document).ready(function() {
	        ...
	        $("#grid-table").jqGrid({
	            ...
	            url : '${basePath}/dict/getTypeListData',
	            mtype : "GET",
	            datatype : "json",
	            colModel : [
	                {
	        ...
	        $("#btn-add").click(function() {//添加页面
		        parent.layer.open({
		            ...
		            fix : false, //不固定
		            maxmin : true,
		            content : '${basePath}/dict/add_type' });
	        });
	        $("#btn-edit").click(function() {
		        ...
		        if(rid == -1) {
			        ...
			        parent.layer.open({
			            ...
			            fix : false, //不固定
			            maxmin : true,
			            content : '${basePath}/dict/add_type?id=' + rid });
		        }
	        });
        ...
        function typeDel() {
	        ...
	        if(rid == -1) {
		        ...
		        layer.confirm('确定要删除（数据列表也会同时删除）？', { btn : [
		            '确定',
		            '取消' ] //按钮
		        }, function() {
			        $.post("${basePath}/dict/del", { "id" : rid }, function(data) {
				        if(data.code == 0) {
					        layer.msg("操作成功", {
					            icon : 1,
					            time : 1000
        ...
        function to_dictdata_list(id) {
	        ...
	        parent.layer.open({
	            ...
	            fix : false, //不固定
	            maxmin : true,
	            content : '${basePath}/dict/data_index?typeId=' + id });
        }
        function reloadGrid() {
