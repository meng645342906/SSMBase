	...
	<script type="text/javascript">
		$(document).ready(function() {
	        ...
	        $("#grid-table").jqGrid({
	            ...
	            url : '${basePath}/dict/getListData?typeId=${typeId}',
	            mtype : "GET",
	            datatype : "json",
	            colModel : [
	                {
	        ...
	        $("#btn-add").click(function() {//添加页面
		        layer.open({
		            ...
		            fix : false, //不固定
		            maxmin : true,
		            content : '${basePath}/dict/add_data?typeId=${typeId}' });
	        });
	        $("#btn-edit").click(function() {
		        ...
		        if(rid == -1) {
			        ...
			        layer.open({
			            ...
			            fix : false, //不固定
			            maxmin : true,
			            content : '${basePath}/dict/add_data?typeId=${typeId}&id=' + rid });
		        }
	        });
        });
        ...
        function delete_data(id) {
	        ...
	        $.post("${basePath}/dict/deleteData", submitData, function(data) {
		        if(data.code == 0) {
			        layer.msg("删除成功", {
			            icon : 1,
			            time : 1000
