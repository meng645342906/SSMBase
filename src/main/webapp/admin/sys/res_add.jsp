                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="validation-form" method="post">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <div class="input-icon input-icon-right" id="kka">
                                        ...
                                        <input type="text" readonly="readonly" id="pname" name="pname"
                                               value="${pRes.name}" class="col-xs-12 col-sm-6">
                                        <button id="menuBtn" type="button" class="btn btn-sm btn-default"
                                                onclick="showMenu(); return false;" style="float: left;">选择
                                        </button>
                                    </div>
                                    <div id="menuContent" class="menuContent"
                                         style="overflow-y: auto; overflow-x: auto; display: none; position: absolute; z-index: 99999; background-color: #FFFFFF; border: 1px solid #858585; height: 250px; width: 270px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <div class="clearfix">
                                        <input type="text" name="name" id="name" value="${sysRes.name}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <div class="clearfix">
                                        <input type="text" name="url" id="url" value="${sysRes.url}"
                                               class="col-xs-12 col-sm-6">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <div class="clearfix">
                                        <input type="text" name="seq" id="seq" value="${sysRes.seq}"
                                               class="col-xs-12 col-sm-6">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right"
                                       for="iconCls">图标</label>
                                <div class="col-xs-12 col-sm-9">
                                    <div class="clearfix">
                                        <input type="text" name="iconCls" id="iconCls" value="${sysRes.iconCls}"
                                               class="col-xs-12 col-sm-6">
                                    </div>
                                </div>
                            </div>
...
<script src="${basePath}/js/ztree/js/jquery.ztree.core.min.js"></script>
<script type="text/javascript">
    ...
    function initformSubmitEvent() {
        $('#validation-form').validate({
            ...
            submitHandler: function (form) {
                ...
                $.post("${basePath}/sys/res/saveRes", postData, function (data) {
