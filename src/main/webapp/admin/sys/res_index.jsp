                ...
                <div class="col-xs-12">
                    <div class="row-fluid" style="margin-bottom: 5px;">
                        <div class="span12 control-group">
                            ...
                            <my:button className="btn btn-primary" id="bnt-add" textName="添加"/>
                            <my:button className="btn btn-info" id="bnt-edit" textName="编辑"/>
                            <my:button className="btn btn-warning" id="bnt-del" textName="删除"
                                       permission="/sys/res/delete"/>
                        </div>
                    </div>
                    <!-- PAGE CONTENT BEGINS -->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#grid-table").jqGrid({
            url: "${basePath}/sys/res/getTreeGridView",
            datatype: "json",
            colModel: [
                {
                    name: "id",
        ...
        $("#bnt-edit").click(function () {
            ...
            parent.layer.open({
                ...
                title: '编辑资源',
                maxmin: true,
                content: '${basePath}/sys/res/add?id=' + id,
                area: [
                    '770px',
                    '430px']
            });
        ...
        $("#bnt-del").click(function () {
            ...
            layer.confirm('确定要删除吗？', {
                ...
                $.post("${basePath}/sys/res/delete", {"id": id}, function (data) {
                    if (data.code == 0) {
                        layer.msg("删除成功", {
                            icon: 1,
                            time: 1000
    ...
    function setVisible(status) {
        ...
        $.post("${basePath}/sys/res/setEnabled", submitData, function (data) {
            if (data.code == 0) {
                layer.msg("操作成功", {
                    icon: 1,
                    time: 1000
