    ...
    <div class="main-content" id="page-wrapper">
        <div class="page-content" id="page-content">
            <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="class_name" name="class_name"
                                                   class="form-control search-query" placeholder="请输入关键字"/>
                                            <span class="input-group-btn">
													<button type="button" id="btn_search" class="btn btn-purple btn-sm">
														<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>
														搜索
													</button>
													<button type="button" id="btn_removeAll" class="btn btn-sm"
                ...
                <div class="col-xs-12">
                    <div class="row-fluid" style="margin-bottom: 5px;"></div>
                    <!-- PAGE CONTENT BEGINS -->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#grid-table").jqGrid({
            ...
            url: '${basePath}/sys/log/getListData',
            mtype: "GET",
            datatype: "json",
            colModel: [
                {
        ...
        $("#btn_search").click(function () {
            ...
            $("#grid-table").jqGrid('setGridParam', {
                datatype: 'json',
                postData: {'class_name': class_name}, //发送数据
                page: 1
    ...
    function removeAll() {
        layer.confirm('确定要清空所有日志吗？', {
            ...
            $.post("${basePath}/sys/log/removeAll", null, function (data) {
                if (data.code == 0) {
                    layer.msg("操作成功", {
                        icon: 1,
                        time: 1000
