...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/assets/css/ace-skins.css"/>
...
<script src="${basePath}/assets/js/additional-methods.js"></script>
<script src="${basePath}/assets/js/bootbox.js"></script>
<script src="${basePath}/assets/js/jquery.maskedinput.js"></script>
<script src="${basePath}/assets/js/select2.js"></script>
<!-- ace scripts -->
<script src="${basePath}/assets/js/ace-elements.js"></script>
<script src="${basePath}/assets/js/ace.js"></script>
    ...
    jQuery(function ($) {
        ...
        $('#validation-form')
            .validate({
                ...
                rules: {
                    oldPwd: {required: true, minlength: 6},
                    newPwd: {required: true, minlength: 6},
                    pwdRepeat: {required: true, minlength: 6}
                },
                messages: {
                    oldPwd: {required: "请输入旧密码", minlength: "旧密码长度最少为6位"},
                    newPwd: {required: "请输入新密码", minlength: "新密码长度最少为6位"},
                    pwdRepeat: {required: "请输入重复密码", minlength: "重复密码长度最少为6位"}
                },
                ...
                submitHandler: function (form) {
                    ...
                    ////oldPwd newPwd pwdRepeat
                    var submitData = {
                        oldPwd: $("#oldPwd").val(), newPwd: $("#newPwd").val(), pwdRepeat: $("#pwdRepeat")
                            .val()
                    };
                    $btn.addClass("disabled");
                    $.post('${basePath}/savePwdUpdate', submitData, function (data) {
