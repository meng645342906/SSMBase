...
public class CommonUtils {
	...
	private static void initJNDI() {
		try {
			...
			prop.put(Context.INITIAL_CONTEXT_FACTORY, JNDI.getObject(Context.INITIAL_CONTEXT_FACTORY));
	...
	private static final String[] HEADERS_TO_TRY = { "X-Forwarded-For", "X-Real-IP", "Proxy-Client-IP",
