...
public class FileUtils {
	...
	public static void copyFile(InputStream in, String fileName, String basePath) throws IOException {
		FileUtils.mkdir(basePath + fileName, true);
	...
	public static void main(String[] args) {
		...
		// boolean
		// bTmp=isFileExist("WEB-INF\\src\\com\\job5156\\util\\FileUtil.java");
		...
		System.out.println("---:" + FileUtils
				.getFileContents(new File("/Users/yulong/git/myutils/src/main/java/com/yulon/util/DesUtil.java")));
	}
}
